...
import main.java.ass03_parte1.Controller.GUI.InfiniteForceException;
...
public class Body {
    ...
    public double getDistanceFrom(Body b) {
        ...
        //System.out.println("Pallina 1 -> x[" + pos.getX() + "] y[" + pos.getY() + "]");
        //System.out.println("Pallina 2 -> x[" + b.getPos().getX() + "] y[" + b.getPos().getY() + "]");
